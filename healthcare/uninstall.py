...
def before_uninstall():
	try:
		print("Removing customizations created by GARP Health...")
		remove_customizations()

	except Exception as e:
		BUG_REPORT_URL = "https://github.com/frappe/health/issues/new"
		click.secho(
			"Removing Customizations for GARP Health failed due to an error."
			" Please try again or"
	...
	click.secho("GARP Health app customizations have been removed successfully...", fg="green")
